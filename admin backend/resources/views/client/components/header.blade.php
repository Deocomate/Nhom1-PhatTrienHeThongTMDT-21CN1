        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between flex-wrap">
                <div class="d-flex align-items-center flex-wrap">
                    <p class="d-flex align-items-center fs-14 mb-2 me-3 "><i class="isax isax-call5 me-2"></i>Toll Free
                        : +1 56565 56594</p>
                    <p class="mb-2 d-flex align-items-center fs-14"><i class="isax isax-message-text-15 me-2"></i>Email
                        : <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                             data-cfemail="bad3d4dcd5fadfc2dbd7cad6df94d9d5d7">[email&#160;protected]</a></p>
                </div>
                <div class="navbar-logo mb-2">
                    <a class="logo-dark header-logo" href="index.html">
                        <img src="/client/assets/img/logo-dark.svg" class="logo" alt="Logo">
                    </a>
                    <a class="logo-white header-logo" href="index.html">
                        <img src="/client/assets/img/logo.svg" class="logo" alt="Logo">
                    </a>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <a href="javascript:void(0);" class="text-white btn btn-dark w-100 mb-2" data-bs-toggle="modal"
                           data-bs-target="#login-modal">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="offcanvas-head">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <a href="index.html" class="black-logo-responsive">
                                    <img src="/client/assets/img/logo-dark.svg" alt="logo-img">
                                </a>
                                <a href="index.html" class="white-logo-responsive">
                                    <img src="/client/assets/img/logo.svg" alt="logo-img">
                                </a>
                                    ...
                                    <div class="w-100">
                                        <div class="dropdown">
                                            <a href="javascript:void(0);"
                                               class="dropdown-toggle bg-white border d-block" data-bs-toggle="dropdown"
                                               aria-expanded="false">
                                                USD
                                            </a>
                                            <ul class="dropdown-menu p-2">
                                                <li><a class="dropdown-item rounded" href="javascript:void(0);">USD</a>
                                                </li>
                                                <li><a class="dropdown-item rounded" href="javascript:void(0);">YEN</a>
                                                </li>
                                                <li><a class="dropdown-item rounded" href="javascript:void(0);">EURO</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div><a href="javascript:void(0);" class="text-white btn btn-dark w-100 mb-3"
                                        data-bs-toggle="modal" data-bs-target="#login-modal">Sign In</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="header-nav">
                <div class="main-menu-wrapper">
                                    ...
                                    <li>
                                        <div class="megamenu-wrapper">
                                            <div
                                                ...
                                                <a href="javascript:void(0);"
                                                   class="btn btn-dark btn-md mb-3 text-white d-inline-block w-auto">Purchase
                                                    Template</a>
                                            </div>
                                                    ...
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index.html"><img
                                                                    src="/client/assets/img/menu/home-01.jpg"
                                                    ...
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-2.html"><img
                                                                    src="/client/assets/img/menu/home-02.jpg"
                                                                    class="img-fluid"
                                                                    alt="img"></a>
                                                        </div>
                                                        <div class="demo-info">
                                                    ...
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-3.html"><img
                                                                    src="/client/assets/img/menu/home-03.jpg"
                                                                    class="img-fluid"
                                                                    alt="img"></a>
                                                        </div>
                                                        <div class="demo-info">
                                                    ...
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-4.html"><img
                                                                    src="/client/assets/img/menu/home-04.jpg"
                                                                    class="img-fluid"
                                                                    alt="img"></a>
                                                        </div>
                                                        <div class="demo-info">
                                                    ...
                                                    <div class="single-demo">
                                                        <div class="demo-img">
                                                            <a href="index-5.html"><img
                                                                    src="/client/assets/img/menu/home-05.jpg"
                                                                    class="img-fluid"
                                                                    alt="img"></a>
                                                        </div>
                                                        <div class="demo-info">
                                                    ...
                                                    <div class="single-demo active">
                                                        <div class="demo-img">
                                                            <a href="index-6.html"><img
                                                                    src="/client/assets/img/menu/home-06.jpg"
                                                                    class="img-fluid"
                                                                    alt="img"></a>
                                                        </div>
                                                        <div class="demo-info">
                                    ...
                                    <li>
                                        <div class="megamenu-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="menu-img">
                                                        <img src="/client/assets/img/menu/flight.jpg" alt="img"
                                                             class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="megamenu-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="menu-img">
                                                        <img src="/client/assets/img/menu/hotel.jpg" alt="img"
                                                             class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="megamenu-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="menu-img">
                                                        <img src="/client/assets/img/menu/car.jpg" alt="img"
                                                             class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="megamenu-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="menu-img">
                                                        <img src="/client/assets/img/menu/cruise.jpg" alt="img"
                                                             class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="tour-booking-confirmation.html">Tour Booking</a>
                                                        </li>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="menu-img">
                                                        <img src="/client/assets/img/menu/tour.jpg" alt="img"
                                                             class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-lg-4">
                                                <div class="col-lg-6">
                                                    <ul>
                                                        ...
                                                        <li><a href="booking-confirmation.html">Booking Confirmation</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-6">
                    ...
                    <div class="header-btn align-items-center">
                        ...
                        <div>
                            <a href="javascript:void(0);" class="text-white btn btn-dark w-100 mb-2"
                               data-bs-toggle="modal" data-bs-target="#register-modal">Sign In</a>
                        </div>
                    </div>
