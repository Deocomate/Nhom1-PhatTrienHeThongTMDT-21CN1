...
export const BlogDetailPage = ({slug}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const blogResponse = await apiService.get(`/blog/getBlogBySlug/${id}`);
    ...
    if (error || !blog) {
        return (<div className="container py-5 text-center text-danger">
                                    ...
                                    <ul>
                                        <li className="ltn__blog-author">
                                            <Image
                                                ...
                                                height={35}
                                            />
                                            <span>Người viết: Nhà thuốc An Khang</span>
                                        </li>
