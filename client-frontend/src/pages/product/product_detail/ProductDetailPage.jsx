...
export default function ProductDetailPage({id}) {
    ...
    return (<>
        <BreadCrumbDefault name="Product Details"></BreadCrumbDefault>
                                ...
                                >
                                    <div className="ltn__shop-details-tab-content-inner">
                                        ...
                                        <p>
                                            ...
                                            natus error sit voluptatem, totam rem aperiam, eaque
