...
export default function DesktopMenu() {
    return (<>
        <div
            className="header-bottom-area ltn__border-top--- ltn__header-sticky  ltn__sticky-bg-white ltn__primary-bg---- menu-color-white---- d-none--- d-lg-block">
                ...
                <div className="row">
                                ...
                                <nav>
                                    <div className="ltn__main-menu">
                                        <ul>
                                            ...
                                            <li>
                                                <Link href="/blog">Cẩm nâng sức khoẻ</Link>
                                            </li>
                                            <li>
                    ...
                    <div className="col-lg-2 align-self-center d-none d-xl-block">
                        <div className="header-contact-info text-end">
                            <a className="font-weight-6 ltn__primary-color"
                               href="tel:+123456789">
