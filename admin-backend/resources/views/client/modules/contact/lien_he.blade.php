...
@section('title', 'King Express Bus liên hệ với chuúng tôi')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card card-body shadow text-center align-items-center h-100">
                            ...
                            <div class="d-grid gap-3 d-sm-block">
                                <button class="btn btn-sm btn-primary-soft"><i
                                        class="bi bi-phone me-2"></i>{{$webInfo->phone}}
                                </button>
                                <button class="btn btn-sm btn-light"><i
                                        class="bi bi-telephone me-2"></i>{{$webInfo->hotline}}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card card-body shadow text-center align-items-center h-100">
                            ...
                            <a href="#" class="btn btn-link text-decoration-underline p-0 mb-0"><i
                                    class="bi bi-envelope me-1"></i>{{$webInfo->email}}</a>
                        </div>
                    </div>
                    <!-- Contact item END -->
                    ...
                    <div class="col-xl-4 position-relative">
                        ...
                        <div class="card card-body shadow text-center align-items-center h-100">
                            ...
                            <!-- Title -->
                            <h5>Mạng xã hội (Social media)</h5>
                            <!-- Buttons -->
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item">
                                    <a class="btn btn-sm bg-facebook px-2 mb-0"
                                       href="{{$webInfo->facebook}}"><i
                                            class="fab fa-fw fa-facebook-f"></i></a></li>
                                <li class="list-inline-item">
                                    <a href="{{$webInfo->zalo}}">
                                        <img
                                            src="https://img.icons8.com/?size=45&id=0m71tmRjlxEe&format=png&color=000000"
                                            alt="zalo">
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="container">
                <div class="row g-4 g-lg-5 align-items-center">
                    ...
                    <div class="col-lg-6 text-center">
                        <img src="/client/assets/plugins/booking/assets/images/element/contact.svg" alt="">
                    </div>
                    <!-- Vector image END -->
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-light p-4">
                            ...
                            <div class="card-header bg-light p-0 pb-3">
                                <h3 class="mb-0">Gửi thông tin liên hệ</h3>
                            </div>
                            ...
                            <div class="card-body p-0">
                                <form class="row g-4" onsubmit="return false">
                                    <!-- Name -->
                                    <div class="col-md-6">
                                        <label class="form-label">Tên (Fullname) *</label>
                                    ...
                                    <!-- Message -->
                                    <div class="col-12">
                                        <label class="form-label">Tin nhắn (Message) *</label>
                                        <textarea class="form-control" rows="3"></textarea>
                                    </div>
                                    <!-- Button -->
                                    <div class="col-12">
                                        <button class="btn btn-dark mb-0" type="button">Gửi thông tin</button>
                                    </div>
                                </form>
                            </div>
                            <!-- Card body END -->
